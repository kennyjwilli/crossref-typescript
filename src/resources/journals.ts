...
import * as JournalsAPI from './journals';
import * as MembersAPI from './members';
import { APIPromise } from '../core/api-promise';
import { RequestOptions } from '../internal/request-options';
import { path } from '../internal/utils/path';

export class Journals extends APIResource {
  /**
   ...
   */
  list(
    query: JournalListParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<JournalListResponse> {
    return this._client.get('/journals', { query, ...options });
  }
  ...
  listWorks(
    ...
    return this._client.get(path`/journals/${issn}/works`, { query, ...options });
  }
}

export interface Journal {
  breakdowns: MembersAPI.BreakdownsObject;

  counts: MembersAPI.DoiCounts;

  coverage: MembersAPI.CoverageFull;

  'coverage-type': MembersAPI.CoverageTypeObject;

  flags: MembersAPI.Flags;
...
export interface JournalRetrieveResponse {
  message: Journal;
...
export interface JournalListResponse {
  message: JournalListResponse.Message;
...
export namespace JournalListResponse {
  export interface Message {
    items: Array<JournalsAPI.Journal>;
...
export interface JournalListWorksParams {
  /**
   * Exposes the ability to deep page through large result sets, where offset would
   * cause performance problems
   */
...
export declare namespace Journals {
  export {
