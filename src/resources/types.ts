...
export class Types extends APIResource {
   ...
   */
  retrieve(id: number, options?: RequestOptions): APIPromise<TypeRetrieveResponse> {
    return this._client.get(path`/types/${id}`, options);
  }
   ...
   */
  list(
    query: TypeListParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<TypeListResponse> {
    return this._client.get('/types', { query, ...options });
  }
  ...
  listWorks(
    id: number,
    query: TypeListWorksParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<MembersAPI.WorksMessage> {
    return this._client.get(path`/types/${id}/works`, { query, ...options });
  }
}
...
export interface TypeRetrieveResponse {
  message: Type;
...
export interface TypeListResponse {
  message: TypeListResponse.Message;
...
export interface TypeListWorksParams {
  /**
