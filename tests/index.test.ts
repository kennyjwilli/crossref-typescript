...
describe('instantiate client', () => {
  ...
  describe('logging', () => {
    ...
    test('debug logs when log level is debug', async () => {
      ...
      const client = new Crossref({ logger: logger, logLevel: 'debug' });
    ...
    test('debug logs are skipped when log level is info', async () => {
      ...
      const client = new Crossref({ logger: logger, logLevel: 'info' });
    ...
    test('debug logs happen with debug env var', async () => {
      ...
      const client = new Crossref({ logger: logger });
    ...
    test('client log level overrides env var', async () => {
      ...
      process.env['CROSSREF_LOG'] = 'debug';
      const client = new Crossref({ logger: logger, logLevel: 'off' });
  ...
  describe('defaultQuery', () => {
    test('with null query params given', () => {
      const client = new Crossref({ baseURL: 'http://localhost:5000/', defaultQuery: { apiVersion: 'foo' } });
    ...
    test('overriding with `undefined`', () => {
      const client = new Crossref({ baseURL: 'http://localhost:5000/', defaultQuery: { hello: 'world' } });
  ...
  test('explicit global fetch', async () => {
    ...
    const client = new Crossref({ baseURL: 'http://localhost:5000/', fetch: defaultFetch });
  });
  ...
  test('normalized method', async () => {
    ...
    const client = new Crossref({ baseURL: 'http://localhost:5000/', fetch: testFetch });
  ...
  describe('baseUrl', () => {
    test('trailing slash', () => {
      const client = new Crossref({ baseURL: 'http://localhost:5000/custom/path/' });
    ...
    test('explicit option', () => {
      const client = new Crossref({ baseURL: 'https://example.com' });
    ...
    test('empty env variable', () => {
      ...
      const client = new Crossref({});
      expect(client.baseURL).toEqual('https://api.crossref.org/v1');
    });
    ...
    test('in request options overridden by client options', () => {
      const client = new Crossref({ baseURL: 'http://localhost:5000/client' });
      expect(client.buildURL('/foo', null, 'http://localhost:5000/option')).toEqual(
  ...
  test('maxRetries option is correctly set', () => {
    const client = new Crossref({ maxRetries: 4 });
    expect(client.maxRetries).toEqual(4);

    // default
    const client2 = new Crossref({});
    expect(client2.maxRetries).toEqual(2);
  });

  describe('withOptions', () => {
    test('creates a new client with overridden options', async () => {
      const client = new Crossref({ baseURL: 'http://localhost:5000/', maxRetries: 3 });
    ...
    test('respects runtime property changes when creating new client', () => {
      const client = new Crossref({ baseURL: 'http://localhost:5000/', timeout: 1000 });
...
describe('retries', () => {
  test('retry on timeout', async () => {
    ...
    const client = new Crossref({ timeout: 10, fetch: testFetch });
  ...
  test('retry count header', async () => {
    ...
    const client = new Crossref({ fetch: testFetch, maxRetries: 4 });
  ...
  test('retry on 429 with retry-after', async () => {
    ...
    const client = new Crossref({ fetch: testFetch });
